...
export default function MobileCTABar() {
  return (
    <div className="min-[620px]:hidden fixed left-0 right-0 bottom-0 z-[60] bg-[rgba(9,15,26,0.95)] backdrop-blur-md border-t border-gold/20 py-3 px-3.5 grid grid-cols-2 gap-2.5">
      <a
